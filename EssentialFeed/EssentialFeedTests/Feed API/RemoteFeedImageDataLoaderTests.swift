...
final class RemoteFeedImageDataLoaderTests: XCTestCase {
    ...
    func test_loadImageDataFromURL_deliversInvalidataErrorOn200HTTPResponseWithEmptyData() {
        let (sut, client) = makeSUT()
    ...
    func test_loadImageDataFromURL_deliversNonEmptyDataOn200HTTResponse() {
        let (sut, client) = makeSUT()
