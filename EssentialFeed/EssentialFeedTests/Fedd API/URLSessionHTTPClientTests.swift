...
//  EssentialFeed
//
//  Created by Fernando Benavides on 26/04/25.
//
...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    private func trackFroMemoryLeaks(_ isntance: AnyObject, file: StaticString = #file, line: UInt = #line) {
    ...
    private class URLProtocolStub: URLProtocol {
        ...
        static func stub(data: Data?, response: URLResponse?, error: Error? = nil) {
            stub = Stub(data: data, response: response, eror: error)
        }
        ...
        override func startLoading() {
            ...
            if let error = URLProtocolStub.stub?.eror {
