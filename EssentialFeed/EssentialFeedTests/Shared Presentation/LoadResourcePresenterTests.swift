...
final class LoadResourcePresenterTests: XCTestCase {
    ...
    func test_didFinishLoadingFeedWithErro_displaysLocalizedErrorMessageAndStopsLoading() {
        let (sut, view) = makeSUT()
    ...
    private func makeSUT(
        ...
        let view = ViewSpy()
        let sut = LoadResourcePresenter(loadingView: view, feedView: view, errorView: view, mapper: mapper)
