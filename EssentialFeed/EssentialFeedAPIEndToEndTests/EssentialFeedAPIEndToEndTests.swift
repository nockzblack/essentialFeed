...
//
//  Created by Fernando Benavides on 28/04/25.
//
...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestsServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case .failure(let error):
            XCTFail("Expected sucessful feed result, got \(error) isntead")
        default:
            XCTFail("Expected sucessful feed result, got no result isntead")
        }
    }
