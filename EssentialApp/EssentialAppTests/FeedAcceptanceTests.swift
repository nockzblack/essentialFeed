...
final class FeedAcceptanceTests: XCTestCase {
    ...
    func test_onLaunch_displayCacheRemoteFeedWhenCustomerHasNoConnectivity() throws {
    ...
    func test_onLaunch_displaysEmotyFeedWhenCustomerHasNoconnectivityAndNoCache() throws {
    ...
    func test_onEnteringBackground_keepNonExpiredFeedCache() throws {
