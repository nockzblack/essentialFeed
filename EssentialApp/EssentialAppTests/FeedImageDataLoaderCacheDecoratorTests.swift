...
final class FeedImageDataLoaderCacheDecoratorTests: XCTestCase, FeedImageDataLoaderTestCase {
    ...
    func test_losdImageData_loadsFromLoader() {
        let url = anyURL()
    ...
    func test_loadImageData_cachesLoadedDataOnLoaderSuccess() {
        ...
        XCTAssertEqual(cache.messages, [.save(data: imageData, for: url)], "Expected to cache loaded image data on successs")
    }
    ...
    func test_loadImageData_doesNotCacheDataOnLoaderFailure() {
        ...
        XCTAssertTrue(cache.messages.isEmpty, "Expected no to cache image dat on load error")
    }
